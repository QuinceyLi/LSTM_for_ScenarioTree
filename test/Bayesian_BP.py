...
for epoch in range(EPOCH):
    ...
    for batch_idx, (train_x, train_y) in enumerate(train_loader):
        # print("trainx:",train_x.shape) # 100,1,28,28
        ...
        # print("mu:",mu.shape) # 100,10
        # print("sigma:",sigma.shape) # 100,10

        prob_total = torch.zeros((NUM_SAMPLES, train_y.size(0), CLASS_NUM))
        # print("prob_totaL:",prob_total.shape) # 10,100,10
        ...
        # print("epsilon:", epsilon.shape) # 100,10
        # print("logit:", logit.shape) # 100,10
        prob_ave = torch.mean(prob_total, 0)
        loss = F.nll_loss(torch.log(prob_ave), train_y)
        # print("prob_ave:", prob_ave.shape) #100,10
        # print("loss:", loss.data.numpy()) # 1
